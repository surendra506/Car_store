...
class Interceptor extends \Magento\Security\Model\ResourceModel\UserExpiration\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
     ...
     * {@inheritdoc}
     */
    public function addActiveExpiredUsersFilter(): \Magento\Security\Model\ResourceModel\UserExpiration\Collection
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addActiveExpiredUsersFilter');
        return $pluginInfo ? $this->___callPlugins('addActiveExpiredUsersFilter', func_get_args(), $pluginInfo) : parent::addActiveExpiredUsersFilter();
    }

    /**
     * {@inheritdoc}
     */
    public function addUserIdsFilter(array $userIds = []): \Magento\Security\Model\ResourceModel\UserExpiration\Collection
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addUserIdsFilter');
        return $pluginInfo ? $this->___callPlugins('addUserIdsFilter', func_get_args(), $pluginInfo) : parent::addUserIdsFilter($userIds);
    }

    /**
     * {@inheritdoc}
     */
    public function addExpiredRecordsForUserFilter(string $userId): \Magento\Security\Model\ResourceModel\UserExpiration\Collection
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addExpiredRecordsForUserFilter');
        return $pluginInfo ? $this->___callPlugins('addExpiredRecordsForUserFilter', func_get_args(), $pluginInfo) : parent::addExpiredRecordsForUserFilter($userId);
    }
