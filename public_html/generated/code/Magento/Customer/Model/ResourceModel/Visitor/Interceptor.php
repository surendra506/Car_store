...
class Interceptor extends \Magento\Customer\Model\ResourceModel\Visitor implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function fetchCreatedAt(int $visitorId): ?int
    {
        ...
        return $pluginInfo ? $this->___callPlugins('fetchCreatedAt', func_get_args(), $pluginInfo) : parent::fetchCreatedAt($visitorId);
    }
    ...
    public function updateCreatedAt(int $visitorId, int $timestamp): void
    {
        ...
        $pluginInfo ? $this->___callPlugins('updateCreatedAt', func_get_args(), $pluginInfo) : parent::updateCreatedAt($visitorId, $timestamp);
    }
