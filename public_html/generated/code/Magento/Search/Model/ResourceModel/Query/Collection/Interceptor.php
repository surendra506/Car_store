...
class Interceptor extends \Magento\Search\Model\ResourceModel\Query\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function setQueryFilter($query)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('setQueryFilter', func_get_args(), $pluginInfo) : parent::setQueryFilter($query);
    }
    ...
    public function setPopularQueryFilter($storeIds = null)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('setPopularQueryFilter', func_get_args(), $pluginInfo) : parent::setPopularQueryFilter($storeIds);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isTopSearchResult');
        return $pluginInfo ? $this->___callPlugins('isTopSearchResult', func_get_args(), $pluginInfo) : parent::isTopSearchResult($term, $storeId, $maxCountCacheableSearchTerms);
    }
    ...
    public function setRecentQueryFilter()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('setRecentQueryFilter', func_get_args(), $pluginInfo) : parent::setRecentQueryFilter();
    }
