...
class Interceptor extends \Magento\Backend\Model\Auth implements \Magento\Framework\Interception\InterceptorInterface
{
     ...
     * {@inheritdoc}
     */
    public function throwException(?\Magento\Framework\Phrase $msg = null)
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'throwException');
        return $pluginInfo ? $this->___callPlugins('throwException', func_get_args(), $pluginInfo) : parent::throwException($msg);
    }
}
