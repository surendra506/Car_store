    ...
    public function getPatternDirs(array $params)
    {
        ...
        while ($theme) {
            if ($theme->getFullPath()) {
                ...
                /**
                 * Some themes (e.g. virtual themes like "frontend/_theme<id>") may be present in configuration/DB
                 * but not registered in the component registrar. In that case, skip this theme and fall back to
                 * its parent to avoid crashing the request.
                 */
                if (!$themeDir) {
